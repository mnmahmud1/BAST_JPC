<?php
    ...
    $getStatusForHide = mysqli_fetch_assoc(mysqli_query($conn, "SELECT EXISTS ( SELECT 1 FROM bast_report WHERE number = '$bast_number' AND status = 0 ) OR EXISTS ( SELECT 1 FROM bast_report WHERE return_reff = '$bast_number' ) AS status"));
?>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <?php endif ?>
                                                                    <?php if($getStatusForHide["status"] == 1) : ?>
                                                                    <?php else : ?>
                                                ...
                                                <div class="col-sm">
                                                    <div class="d-grid gap-2">
                                                        ...
                                                        <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                                            data-bs-target="#modalTambahBarang" disabled>Tambah Data
                                                            Barang</button>
                                                        <?php else : ?>
                                                        <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-sm">
                                                    <div class="d-grid gap-2">
                                                        <?php if($getStatusForHide["status"] == 1) : ?>
                                                        <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                                            data-bs-target="#modalTambahLisensi" disabled>Tambah Data
                                                            Lisensi</button>
                                                        <?php else : ?>
                                                        <button class="btn btn-sm btn-primary" data-bs-toggle="modal"
