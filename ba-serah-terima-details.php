                ...
                <div class="container-fluid px-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-sm text-end">
                                            <a href="berita-acara-serah-terima.php" class="btn btn-light">Cancel</a>
                                            <a href="berita-acara-serah-terima.php" class="btn btn-primary">Save</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm">
                                            <div class="d-grid gap-2">
                                                <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal"
                                                    data-bs-target="#modalTambahLisensi">Tambah Data Lisensi</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                    ...
                    <div class="row my-4">
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="col">
                                <label for="bast-signed" class="form-label labeling-form">UPLOAD BAST SIGNED</label> <a
                                    href="#" class="text-decoration-none labeling-form text-decoration-underline">SEE
                                    PDF</a>
                                <input type="file" name="bast-signed" id="bast-signed" class="form-control" required />
                            </div>
                        </form>
                    </div>
                </div>
