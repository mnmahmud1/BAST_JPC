                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= date("d/m/Y", strtotime($lisensi['date_start'])) ?> -
                                                    ...
                                                    <?php elseif(strtotime($lisensi['date_end']) < strtotime(date("Y-m-d H:i:s")) ) : ?>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm">
                                ...
                                <input type="number" class="form-control" placeholder="Your text here" name="seatsM"
                                    id="seatsM" maxlength="3" oninput="enforceMaxLength(this)" required />
                            </div>
                            <div class="col-sm">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm">
                                ...
                                <input type="number" class="form-control" placeholder="Your text here" name="seats"
                                    id="seats" maxlength="3" oninput="enforceMaxLength(this)" required />
                            </div>
                            <div class="col-sm">
