				...
				<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
					<div class="sb-sidenav-menu">
						<div class="nav">
							...
							<a class="nav-link" href="#" data-bs-toggle="collapse" data-bs-target="#collapseLayoutsBAST" aria-expanded="true" aria-controls="collapseLayoutsBAST">
								<div class="sb-nav-link-icon">
									<i class="fas fa-columns"></i>
								</div>
								Berita Acara
							...
							<div class="collapse" id="collapseLayoutsBAST" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
								<nav class="sb-sidenav-menu-nested nav">
				...
				<main>
					<div class="container-fluid px-4">
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="barang-masuk.html">Barang Masuk</a></li>
									...
									<div class="card-body">
										...
										<div class="row mb-4">
											<div class="col-sm">
												...
												<input type="text" class="form-control" placeholder="You Text Here" name="" id="" value="IT-RR-2023-05-01" required readonly />
											</div>
											<div class="col-sm">
												<label for="" class="form-label labeling-form">Date</label>
												<input type="date" class="form-control" placeholder="Your text here" name="" id="datePicker" required />
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm">
												<table class="display" name="tableBarang" id="tableBarang">
													...
													<tbody>
														<tr>
															...
															<td>
																<button class="btn btn-sm" onclick="confirm('Yakin ingin menghapus data ini?')">
										...
										<div class="row mb-3">
											<div class="col-sm">
												<div class="d-grid gap-2">
													<button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#modalTambahBarang">Tambah Data Barang</button>
												</div>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm">
												<label for="" class="form-label labeling-form">Additional Information</label>
												<textarea type="text" class="form-control" placeholder="Your Text Here" name="" id=""></textarea>
											</div>
										</div>
										<div class="row mb-4">
											<div class="col-sm text-end">
												<a href="barang-masuk.html" class="btn btn-light">Cancel</a>
												<a href="barang-masuk.html" class="btn btn-primary">Save</a>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="modal-body px-4">
							<div class="row mb-3">
								<div class="col-sm">
									...
									<input type="text" class="form-control" placeholder="Your text here" name="" id="" autofocus required />
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm">
									<label for="" class="form-label labeling-form">Serial Number</label>
									<input type="text" class="form-control" placeholder="Your text here" name="" id="" required />
								</div>
							</div>
							<div class="row mb-3">
								<div class="col-sm">
